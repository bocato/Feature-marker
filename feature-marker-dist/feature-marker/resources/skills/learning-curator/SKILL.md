...
description: Summarizes PR review comments and CI failure logs into structured fix patterns for the learning store. First real consumer of the ADR-010 skill registry.
hooks:
  - phase4_5.summarize
  - learning.curate
timeout_seconds: 60
